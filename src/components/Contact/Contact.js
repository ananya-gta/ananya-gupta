  ...
  return (
    <section className="contact section" id="contact">
      ...
      <div className="contact__container container grid">
        <div className="contact___content">
          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">anannya.gta@gmail.com</span>
              <a
                href="mailto:anannya.gta@gmail.com"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">in/ananya-gupta-1902</span>
              <a
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">@ananyxgupta</span>
              <a
